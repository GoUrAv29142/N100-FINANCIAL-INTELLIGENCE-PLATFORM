...
from src.etl.loader import load_all_raw, FILES
from src.etl.validator import run_all_rules, has_critical_failures
...
def _get_raw_row_counts() -> Dict[str, int]:
    from src.etl.loader import read_raw_sheet
    counts = {}
    for name in FILES:
        try:
